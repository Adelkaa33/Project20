...
public class BookEditor {
    ...
    public static void main(String[] args) {
        ...
        // Лямбда для заголовка: преобразование в верхний регистр с добавлением переноса строки
        bookEditor.setHeaderDecorator(header -> header.toUpperCase() + "\n");

        // Лямбда для строк: первая буква заглавная
        bookEditor.addLineProcessor(line -> line.substring(0, 1).toUpperCase() + line.substring(1));

        // Новый обработчик: добавление символа переноса строки в конец строки
...
// Классы ToUpperCaseHeaderDecorator и CapitalizeFirstLetterProcessor удалены, они заменены лямбда-функциями
